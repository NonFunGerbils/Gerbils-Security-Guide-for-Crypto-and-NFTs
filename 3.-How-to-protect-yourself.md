...
[Simple Login](https://simplelogin.io/) I think offers one of the best services for this. You can import your own domain names make them catch-all. For example you can have the domain name **gerbilpoo.com** and accept email to **<i>coinbase1436</i>@gerbilpoo.com**, **<i>5578github</i>@gerbilpoo.com** and a unique email for every account.
...
For low importance services such as newsletters or online purchases you can use a randomly generated alias on the simplelogin.com domains which increases privacy but reduces personal redundancy.
