...
**VOIP Numbers** - Your secondary numbers can be VOIP numbers, these are kept with an online service such as Google Voice or Twilio which offer good security and remove the sim swap vulnerability. Voip numbers are great because you can have as many of them as you want and can have them call through to multiple devices both mobile and desktop.
...
* Port your old personal number to a VOIP service
* Create a secondary VOIP number for giving out to services and companies when needed
* keep your new cellular number completely secret and give out to no one (you don't even need to know it)
