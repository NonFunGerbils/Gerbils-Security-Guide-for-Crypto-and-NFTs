...
Opening malicious files sent to you that contain some malware/virus to compromise your device. Typically these would be executable files but can also be document or spreadsheet files or other executables such as SCR saved to look like a PDF such as in this tweet [such as in this tweet](https://twitter.com/Serpent/status/1540770171069276160?s=20&t=QDjjWRGWigvRcwYbmJ2Tgg).
